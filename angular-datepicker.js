angular.module("angular-datepicker", []).directive("datepicker", function ($timeout, padFilter) {
    return {
        restrict: "A",
        scope: {
            options: "=?options",
